...
// console.log('Bài 1.2: Use the for loop to print/log out the following output');
...
// console.log('Bài 3.1: ');
// console.log("Type of outermost layer is "+ typeof(data))

// console.log('Bài 3.2: ');
// console.log("Type of hit is "+ typeof(data.hits));
// console.log(data.hits[0]['location'])
// console.log('Bài 3.3: ');
// console.log('Có thể sử dụng :data.hits[0].(property) ');
...
//  if(word!=x)
//  {
//      alert('Cannot found '+ word + ' in dictionary!');
//  }
//  console.log(count);
...
// {
//     jobHits.push(jobData[i]);
// }
// console.log(jobHits); 
// console.log('Bài 15.2: ');
// let jobData = {
//     hits: [
//         {
//             benefits: [
